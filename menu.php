...
if (isset($_POST['submit1'])) {
  ...
  $table = $_POST['People'];
   $date = $_POST['date'];
   $email1=  $_POST['email1'];
   $message="We have received your table booking for $date for $table guests."."\n"."We are awaiting your arrival."."\n\n"."Your requirements are $mes. We surely will take of all your requirements"."\n\n\n"."Thanks,"."\n"."Purvi Sharma";
 $header="FROM: pizzaspecials2002@gmail.com";

if( mail($email1,$subject,$message,$header))
{
  echo "<script>alert('Booking is Done!!! Thank You for Booking')</script>";
  }
  else
  {
...
<!-- Header image -->
<div style="height:800px;background-image:url('imagepizza.jpg');background-size:cover;"
...
<p>The Pizza Restaurant was founded in Pune by Mr. Patel in lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
